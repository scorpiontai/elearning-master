            ...
            <div class="wrapper">
                <form action="" class="login-container">
                    ...
                    <div class="input-container">
                        <input id="input-login" type="" name="username" placeholder="Username">
                    </div>
                    <div class="input-container">
                    ...
                    <div class="captcha-container">
                        ...
                        <input id="input-login" type="" placeholder="Enter Captcha">
                    </div>
                    <p id="signup1">Don't have an account? </p><router-link to="/signup" id="signup">Sign up here</router-link>
